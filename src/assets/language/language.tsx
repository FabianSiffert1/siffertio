const language = {
    ...
    ENGLISH_STUDIES_DESCRIPTION: 'I hold a Bachelor of Arts degree from Heinrich Heine University in Duesseldorf, with a major in English and American Literature and a minor in Philosophy. To improve my English skills, I spent nearly a year living and studying in Port Elizabeth/Gqeberha, South Africa. During this time, I volunteered at Walmer Secondary School and the Masifunde Changemaker Academy, actively trying to contribute to the local community and gaining valuable experiences.',
    ...
    PROJECT_SIFFERTIO_DESCRIPTION: 'You are here. A personal portfolio with a focus on simplistic design. A pet project written over the course of my apprenticeship. Be aware: Code quality may vary.',
